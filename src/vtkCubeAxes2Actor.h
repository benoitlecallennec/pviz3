...
class vtkCubeAxes2Actor : public vtkActor
{
public:
    vtkTypeMacro(vtkCubeAxes2Actor,vtkActor);
    void PrintSelf(ostream& os, vtkIndent indent);
    
    // Description:
    // Instantiate object with label format "6.3g" and the number of labels
    // per axis set to 3.
    static vtkCubeAxes2Actor *New();
    ...
    void ShallowCopy(vtkCubeAxes2Actor *actor);
...
private:
    vtkCubeAxes2Actor(const vtkCubeAxes2Actor&); // Not implemented
    void operator=(const vtkCubeAxes2Actor&); // Not implemented
    ...
    //void SetTicksDelta(vtkAxisActor *axes[4],
