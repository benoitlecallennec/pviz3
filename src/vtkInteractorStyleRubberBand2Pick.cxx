/*=========================================================================
 ...
 Module:    $RCSfile: vtkInteractorStyleRubberBand2Pick.cxx,v $
...
//#include "vtkRendererWindow.h"
#include "vtkDataSetMapper.h"


#include <QDebug>

//vtkCxxRevisionMacro(vtkInteractorStyleRubberBand2Pick, "$Revision: 1.11 $");
vtkStandardNewMacro(vtkInteractorStyleRubberBand2Pick);

#define VTKISRBP_ORIENT 0
#define VTKISRBP_SELECT 1

//--------------------------------------------------------------------------
vtkInteractorStyleRubberBand2Pick::vtkInteractorStyleRubberBand2Pick()
{
...
//--------------------------------------------------------------------------
void vtkInteractorStyleRubberBand2Pick::StartSelect()
{
	this->CurrentMode = VTKISRBP_SELECT;
}

void vtkInteractorStyleRubberBand2Pick::EndSelect()
{
	this->CurrentMode = VTKISRBP_ORIENT;
}

//--------------------------------------------------------------------------
void vtkInteractorStyleRubberBand2Pick::OnChar()
{
...
//--------------------------------------------------------------------------
void vtkInteractorStyleRubberBand2Pick::OnLeftButtonDown()
{
	...
	// Only work GetPixelData in QVTKWidget
...
//--------------------------------------------------------------------------
void vtkInteractorStyleRubberBand2Pick::OnMouseMove()
{
	if (this->CurrentMode != VTKISRBP_SELECT)
    {
		//if not in rubber band mode,  let the parent class handle it
...
//--------------------------------------------------------------------------
void vtkInteractorStyleRubberBand2Pick::OnLeftButtonUp()
{
	if (this->CurrentMode != VTKISRBP_SELECT)
    {
		//if not in rubber band mode,  let the parent class handle it
...
//--------------------------------------------------------------------------
void vtkInteractorStyleRubberBand2Pick::RedrawRubberBand()
{
...
//--------------------------------------------------------------------------
void vtkInteractorStyleRubberBand2Pick::Pick()
{
	//qDebug() << "vtkInteractorStyleRubberBand2Pick:Pick() ... ";
	...
	if (this->State == VTKIS_NONE) 
    {
		...
		if ( picker != NULL )
		{
			...
			if (areaPicker != NULL)
			{
                //qDebug() << "areaPicker ... " << "(" << min[0] << "," << min[1] << "," << max[0] << "," << max[1] << ")";
				areaPicker->AreaPick(min[0], min[1], max[0], max[1], 
									 this->CurrentRenderer);
			}
			else
			{
                //qDebug() << "picker ... " << "(" << rbcenter[0] << "," << rbcenter[1] << "," << "0.0)";
...
//--------------------------------------------------------------------------
void vtkInteractorStyleRubberBand2Pick::PrintSelf(ostream& os, vtkIndent indent)
{
